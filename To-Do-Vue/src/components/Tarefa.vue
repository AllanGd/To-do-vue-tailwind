<template>
  <div class="grid-col-3 grid gap-1">
    <div class="col-span-3 grid grid-cols-2 rounded-t-md border-2 border-gray-300 bg-gray-100 p-2 text-lg text-gray-500">
      <span class="col-span-2 row-span-2 mt-2 h-24">teste card de tarefa</span>
      <span class="self-end text-base">Prazo: 15/03/2023</span>
      <span class="self-end text-base font-bold text-orange-600 justify-self-end">Próximo do vencimento</span>
    </div>
    <button class="col-span-1 rounded-bl-md drop-shadow-md bg-emerald-400 p-1 text-lg font-bold hover:bg-emerald-500 active:bg-emerald-600">
    ...
    <button class="col-span-1 rounded-br-md bg-red-400 drop-shadow-md p-1 text-lg font-bold hover:bg-red-500 active:bg-red-600">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline h-6 w-6">
